...
bot.hears("/start", (ctx) => {
  ...
  ctx
    .replyWithHTML(
      `Hey ${userName},<br><br><b>Welcome to Cribble AI Agent 🚀</b><br><br>` +
        `"Empowering founders, investors, and Web3 explorers with predictive insights through decentralized AI"<br><br>` +
        `<b>What I Can Do For You:</b><br><br>` +
        `🔍 <b>Community Analysis</b><br>` +
        `Unlock growth metrics, sentiment trends, and engagement patterns for any Web3 community (Try: Telegram/X communities)<br><br>` +
        `💎 <b>Token Analysis</b><br>` +
        `Get real-time price action, liquidity maps, whale alerts, and volatility predictions<br>(Works with 50+ chains & 10,000+ tokens)<br><br>` +
        `🎯 <b>Rewards Finder</b><br>` +
        `Automatically discover active airdrops, NFT claims, and staking opportunities<br><br>` +
        `🤖 <b>Research Agent</b><br>` +
        `Instant answers about protocols, trends, and any query about Web3 space<br><br>` +
